...
void ReplaceSpace(std::string&); // Replaces whitespace between digits with a single '*' (same as TI-89).

void RemoveSpace(std::string&); // Removes all whitespace from input string.

void DecimalSeparated(std::string&); // Inserts a '*' when 2 digits are separated by 2 '.'.
...
bool CheckOperator(const std::string&); // Checks whether an operator has digits on both sides.
...
void Exponentiaion(std::string&, unsigned int); // Performs exponentiation.

void Multplication(std::string&, unsigned int); // Performs multiplication.

void Division(std::string&, unsigned int); // Performs division.

void Addition(std::string&, unsigned int); // Performs addition.

void Subtraction(std::string&, unsigned int); // Performs subtraction.
